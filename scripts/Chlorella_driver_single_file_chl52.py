...
analyzer.cutoff2(min_fraction=0.5,drop_limit = 10,factor_stddev = 3, plot_true=True) # True peak start as soon as backwards from peak we get inside 3 times stddev of noise, this means from thereon we are within 99.7% of noise datapoints (normal distribution), conservative. Good
...
outpath = Path("saved_single_analyzers") / "Chl52_single_analyzer.pkl"
