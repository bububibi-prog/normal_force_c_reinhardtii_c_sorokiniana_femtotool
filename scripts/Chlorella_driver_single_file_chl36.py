...
analyzer.smooth_force_time(med_kernel = 11, sg_window= 27, sg_order= 2,plot_true = True) # Good
...
analyzer.cutoff2(min_fraction=0.1,drop_limit = 7,factor_stddev = 3, plot_true=True) # True peak start as soon as backwards from peak we get inside 3 times stddev of noise, this means from thereon we are within 99.7% of noise datapoints (normal distribution), conservative. Good
...
outpath = Path("saved_single_analyzers") / "Chl36_single_analyzer.pkl"
