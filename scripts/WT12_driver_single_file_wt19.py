...
filename = "wt_19.txt"
subfolder = "260417 optimal chlamy/"
subfolder_cell_diameter = "260417 optimal chlamy - cell size/"
...
analyzer.smooth_force_time(med_kernel = 31, sg_window= 51, sg_order= 2,plot_true = True) # Good
...
analyzer.cutoff2(min_fraction=0.5,drop_limit = 12,factor_stddev = 3, plot_true=True) # True peak start as soon as backwards from peak we get inside 3 times stddev of noise, this means from thereon we are within 99.7% of noise datapoints (normal distribution), conservative. Good
...
analyzer.calc_bursting_force_energy(label_add2 = "Sigma_0.04",data_str = "Gauss", plot_true = True)
...
outpath = Path("saved_single_analyzers") / "WT12_19_single_analyzer.pkl"
