...
analyzer.detect_contact_slope(start_noise = 30, r_noise = 0.20, min_noise = 70,threshold_sigma=5,plot_true = True) # Good
...
outpath = Path("saved_single_analyzers") / "Chl40_single_analyzer.pkl"
